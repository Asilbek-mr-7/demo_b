...
try:
    ...
    register(
        bz2.compress, bz2.decompress, "application/x-bz2", aliases=["bzip2", "bzip"]
    )
...
try:
    ...
    register(
        brotli.compress, brotli.decompress, "application/x-brotli", aliases=["brotli"]
    )
...
try:
    ...
    register(
        lzma.compress, lzma.decompress, "application/x-lzma", aliases=["lzma", "xz"]
    )
