...
class Channel(virtual.Channel):
    ...
    def _put_fanout(self, exchange, message, routing_key, **kwargs):
        self.broadcast.insert({"payload": dumps(message), "queue": exchange})
    ...
    def get_table(self, exchange):
        ...
        return localRoutes | frozenset(
            (r["routing_key"], r["pattern"], r["queue"]) for r in brokerRoutes
        )
    ...
    def _create_broadcast(self, database):
        ...
        database.create_collection(
            self.broadcast_collection, size=self.capped_queue_size, capped=True
        )
