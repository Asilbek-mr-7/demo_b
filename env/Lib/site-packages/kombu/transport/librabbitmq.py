...
class Transport(base.Transport):
    ...
    connection_errors = base.Transport.connection_errors + (
        ConnectionError,
        socket.error,
        IOError,
        OSError,
    )
    channel_errors = base.Transport.channel_errors + (ChannelError,)
    driver_type = "amqp"
    ...
    def __init__(self, client, **kwargs):
        ...
        self.default_ssl_port = kwargs.get("default_ssl_port") or self.default_ssl_port
        self.__reader = None
