    ...
    def publish(
        ...
        **properties,
        ...
        body, content_type, content_encoding = self._prepare(
            body, serializer, content_type, content_encoding, compression, headers
        )
...
class Consumer:
    ...
    def __init__(
        ...
        self.callbacks = self.callbacks or [] if callbacks is None else callbacks
    ...
    def qos(self, prefetch_size=0, prefetch_count=0, apply_global=False):
        ...
        """
        return self.channel.basic_qos(prefetch_size, prefetch_count, apply_global)
    ...
    def _add_tag(self, queue, consumer_tag=None):
        tag = consumer_tag or "{}{}".format(self.tag_prefix, next(self._tags))
